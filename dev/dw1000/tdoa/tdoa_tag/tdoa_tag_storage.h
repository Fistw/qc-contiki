#ifndef __TDOA_TAG_STORAGE_H__
#define __TDOA_TAG_STORAGE_H__
...
// uint8_t tdoaStorageGetListOfActiveAnchorIds(tdoïaAnchorInfo_t anchorStorage[], uint8_t unorderedAnchorList[], const int maxListSize, const uint32_t currentTime_ms);
